...
$query=mysqli_query($con,"insert into tblcategory(categoryName,AddedBy) values('$cname','$addedby')");
if($query){
...
<head>
  ...
  <title>Support Ticket System   | Add Category</title>
...
<!--  Table No--->
   <div class="form-group">
                    <label for="exampleInputFullname">Category Name</label>
