...
<head>
  ...
  <title>Support Ticket System  | B/w Dates Report Details</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            ?>
            <h1>Tickets Report From <?php echo htmlentities($fromdate);?> To <?php echo htmlentities($todate);?></h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select * from tbltickets where  date(creationDate) between '$fdate' and '$tdate'");
$cnt=1;
